...
def validate_date(date_str):
    ...
    Удален обратный слеш перед 20, чтобы избежать ошибки Invalid group reference.
    """
    # Проверяет формат YYYY-MM-DD для 2020-2039 годов
...
def sort_treeview_column(tree, col, reverse):
    ...
    # Пытаемся сортировать как числа, если не выходит — как строки
    try:
